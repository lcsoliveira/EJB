...
public class TesteTimerImpl implements TesteTimerLocal {
	...
	private static final String NOME_TIMER = "";
	...
	public void agendar(long inicio, long intervalo) {
		TimerService timeService = ctx.getTimerService();
		timeService.createTimer(inicio, intervalo, NOME_TIMER);
	}

	// método que vai executar a implementação
	@Timeout
	public void executar(Timer time) {
	...
	public void cancelar() {
		TimerService timeService = ctx.getTimerService();
		Collection timers = timeService.getTimers();
