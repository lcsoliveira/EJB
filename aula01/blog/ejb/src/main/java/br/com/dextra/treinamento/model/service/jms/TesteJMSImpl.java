...
public class TesteJMSImpl implements TesteJMSLocal {
	...
	public void enviarMensagemQueue() {
		...
		try {
			...
			// TextMessage msg =
			// session.createTextMessage("Esta eh a mensagem enviada para
			// fila");
			// publisher.send(msg);

			// Aqui estamos inicializando o construtor da classe Post passando
			// dois valores
			// Isso só é possível porque na classe POST existe um construtor que
			// precisa receber esses dois valores, e ali o construtor faz um "set"
